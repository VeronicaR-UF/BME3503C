function nii2png_BT(path, file, choice)
...
%%% I just turned this into the function and made some slight edits from the original I found online by Alexander Laurence %%%

%% Turn from .nii to .png %%

warning off; current = pwd;
% % path = 'Task01_BrainTumour\'; %%% old code = uigetdir(pwd,'select your working directory')
cd(path);
